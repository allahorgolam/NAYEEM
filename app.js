...
const displayBooks = (books, data) => {
    ...
    resultAmount.innerHTML = `<h5 style="text-align:center;" class="w-50 mx-auto">About ${data.numFound} results found</h5>`
   ...
   if (books.length > 0){
    ...
    // showing nothing found
        ...
        <h4>No results containing abour your search item.</h4> 
      <ul>
        Suggestions:
        <li>Type your right keyword.</li>
